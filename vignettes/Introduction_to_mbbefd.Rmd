...
$\cdot `r round((100-retainedLoss*100),1)`\% =`r round(prem,1)`k$. 

### Losses above limit

Here we  select the band with a maximum MPL of CHF 90m and a mean gross
MPL of  CHF 81m. Because of the limit of CHF $`r round(L, 1)`$ only that 
...
$\cdot 1,918k=`r round(4155/81000*1918,1)`k$.

Multiplying the premium with the reinsurer's share of the loss gives
us a premium of CHF 
$`r round(4155/81000*1918*(1-ecMBBEFD(D/L, b=swissRe(4)['b'], g=swissRe(4)['g'])),1)`k$.
