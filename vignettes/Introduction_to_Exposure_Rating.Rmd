...
vignette: |
  %\VignetteIndexEntry{Introduction to Exposure Rating} %\VignetteEngine{knitr::rmarkdown} \usepackage[utf8]{inputenc}
---
...
Exposure rating uses the loss experience of a similar portfolio of policies to estimate the expected losses of the portfolio to be covered. The method is often used as a benchmark when there is no sufficient credible claims history from the client.
...
assuming that the relative loss size distribution is independent of individual characteristic of the risk.  
