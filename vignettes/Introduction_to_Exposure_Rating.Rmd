...
dat <- data.frame(
  ...
  G = c(mbbefdExposure(Deductible, b=swissRe(1.5)['b'], g=swissRe(1.5)['g']),
        mbbefdExposure(Deductible, b=swissRe(2.0)['b'], g=swissRe(2.0)['g']),
        mbbefdExposure(Deductible, b=swissRe(3.0)['b'], g=swissRe(3.0)['g']),
        mbbefdExposure(Deductible, b=swissRe(4.0)['b'], g=swissRe(4.0)['g']),
        mbbefdExposure(Deductible, b=swissRe(5.0)['b'], g=swissRe(5.0)['g']))  
)
