...
vignette: "%\\VignetteIndexEntry{Introduction to Exposure Rating} \n%\\VignetteEngine{knitr::rmarkdown}
...
```{r ExposureCurve, dev.args=list(pointsize=8), fig.height=2.75, fig.width=3}
MPL <- 200
ExpectedLoss <- 65
...
```{r mbbefdPlot, fig.height=2.5, fig.width=6, echo=FALSE, warning=FALSE}
