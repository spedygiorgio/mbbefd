...
```{r, fig.height=2.5, fig.width=6, echo=FALSE, warning=FALSE, fig.align="center"}
library(lattice)
n <- 100
...
The integration by parts theorem $\int u(x) v'(x) \, dx = u(x) v(x) - \int v(x) \, u'(x)  dx$ helps with the first part of the integral:
...
```{r bootstrapplot,echo=FALSE, fig.height=3.5, fig.width=3.5, fig.align="center"}
...
Applying the function to our data we get a premium rate of `r round(pr*100,2)`%.
