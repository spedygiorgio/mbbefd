...
%______________________________________________________
\section{Examples of MBBEFD curves}\label{sec:examples}\label{sec:package}
...
net<-ecmbbefd(x=1/2, a=0.2,b=0.04)*40000
ceded<-40000-net
@
...
expectedLoss<-mmbbefd(order=1,a=0.2,b=0.04)*40000
expectedLoss
@
...
smbbefd<-function(...) pmbbefd(lower.tail=FALSE, ...)
...
pTotalLoss<-tlmbbefd(a=0.2,b=0.04)
pTotalLoss
@
